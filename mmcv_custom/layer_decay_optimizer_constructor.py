...
class LayerDecayOptimizerConstructorSwin(DefaultOptimWrapperConstructor):
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        for name, param in module.named_parameters():
            ...
            if len(param.shape) == 1 or name.endswith(".bias") or ('pos_embed' in name) or ('cls_token' in name) or ('rel_pos_' in name) or ('relative_position_bias_table' in name):
                group_name = "no_decay"
                this_weight_decay = 0.
            else:
                group_name = "decay"
            ...
            layer_id = get_num_layer_for_swin(name, num_layers, depths, layer_sep)
