...
# Backbone_VSSM_sp: nn.Module = build.vmamba.Backbone_VSSM_sp
# @MODELS_MMSEG.register_module()
# @MODELS_MMDET.register_module()
# class MM_VSSM_sp(BaseModule, Backbone_VSSM_sp):
#     def __init__(self, *args, **kwargs):
#         BaseModule.__init__(self)
#         Backbone_VSSM_sp.__init__(self, *args, **kwargs)
