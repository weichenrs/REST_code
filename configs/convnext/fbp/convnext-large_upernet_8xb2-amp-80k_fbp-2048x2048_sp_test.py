_base_ = [
    ...
    '../../_base_/datasets/fbp_7200x7200_sp_new.py', 
...
# checkpoint_file = 'proj/spvit/work_dirs/fbp/convnext/convnext-large_upernet_8xb2-amp-80k_fbp-512x512.py/0723/best_mIoU_iter_72000.pth'
