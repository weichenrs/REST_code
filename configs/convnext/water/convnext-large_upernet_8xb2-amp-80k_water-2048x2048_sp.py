_base_ = [
    ...
    '../../_base_/datasets/glhwater_2048x2048_sp.py', 
...
# checkpoint_file = 'proj/spvit/work_dirs/water/convnext/convnext-large_upernet_8xb2-amp-80k_water-512x512.py/0723/best_mIoU_iter_64000.pth'
checkpoint_file = 'proj/spvit/work_dirs/water/convnext/convnext-large_upernet_8xb2-amp-80k_water-512x512.py/0806/best_mIoU_iter_78000.pth'
...
model = dict(
    ...
    auxiliary_head=dict(in_channels=768, num_classes=num_classes, pretrained = checkpoint_file),
