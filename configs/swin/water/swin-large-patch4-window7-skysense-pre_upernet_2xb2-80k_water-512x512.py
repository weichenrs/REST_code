_base_ = [
    ...
    # '../../_base_/datasets/glhwater_512x512.py',
    '../../_base_/datasets/glhwater_512x512_testwhole.py',
...
# checkpoint_file = 'proj/spvit/lwcresult/lwcmodel/water_normal_sswinl_upernet_512_1__6.pth'
# checkpoint_file = 'proj/spvit/lwcresult/lwcmodel/water_normal_swinl_upernet_512_1__12.pth'
checkpoint_file = 'proj/spvit/lwcresult/lwcmodel/water_normal_sswinl_upernet_512_1__best.pth'
...
# val_dataloader = dict(batch_size=64, num_workers=64)
