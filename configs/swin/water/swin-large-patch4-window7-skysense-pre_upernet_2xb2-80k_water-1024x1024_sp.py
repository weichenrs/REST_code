_base_ = [
    '../../_base_/models/upernet_swin.py', '../../_base_/datasets/glhwater_1024x1024_sp.py',
...
# checkpoint_file = 'proj/spvit/work_dirs/water/swin/swin-large-patch4-window7-skysense-pre_upernet_2xb2-80k_water-512x512.py/0806_8x2/iter_80000.pth'
