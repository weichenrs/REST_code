_base_ = [
    '../../_base_/models/upernet_swin.py', '../../_base_/datasets/uavid_2048x2048_sp.py',
...
# checkpoint_file = 'proj/spvit/work_dirs/fbp/swin-large-patch4-window7-skysense-pre_upernet_2xb2-80k_fbp-2048x2048_sp_layer_new_data_bs8.py/0912/best_mIoU_iter_6500.pth'
