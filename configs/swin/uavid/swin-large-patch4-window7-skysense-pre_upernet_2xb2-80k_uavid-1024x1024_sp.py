_base_ = [
    '../../_base_/models/upernet_swin.py', '../../_base_/datasets/uavid_1024x1024_sp.py',
...
checkpoint_file = 'work_dirs/uavid/swin-large-patch4-window7-skysense-pre_upernet_2xb2-80k_uavid-512x512_decay.py/1107/best_mIoU_iter_76000.pth'
