_base_ = [
    '../../_base_/models/upernet_swin.py', '../../_base_/datasets/uavid_4096x4096_sp.py',
...
checkpoint_file = 'work_dirs/uavid/swin-large-patch4-window7-skysense-pre_upernet_2xb2-80k_uavid-512x512_decay.py/1107_4card/best_mIoU_iter_72000.pth'
# checkpoint_file = 'proj/spvit/work_dirs/fbp/swin-large-patch4-window7-skysense-pre_upernet_2xb2-80k_fbp-4096x4096_sp_layer_new_data_bs8.py/0912/best_mIoU_iter_6500.pth'


model = dict(
    # type='SPEncoderDecoder_show',
