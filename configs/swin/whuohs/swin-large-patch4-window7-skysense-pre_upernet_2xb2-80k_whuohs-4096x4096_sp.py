_base_ = [
    '../../_base_/models/upernet_swin.py', '../../_base_/datasets/whuohs_4096x4096_sp.py',
...
# checkpoint_file = 'proj/spvit/work_dirs/whuohs/swin-large-patch4-window7-skysense-pre_upernet_2xb2-80k_whuohs-512x512.py/0717/best_mIoU_iter_26000.pth'
