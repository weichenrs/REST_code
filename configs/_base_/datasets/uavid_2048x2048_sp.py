...
data_root = '../../data/uavid/2048'
data_test_root = '../../data/uavid/ori'
crop_size = (2048, 2048)
train_pipeline = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='trainval/img', seg_map_path='trainval/mask'),
...
val_evaluator = dict(type='IoUMetric', iou_metrics=['mIoU', 'mFscore',"mFscore"])
