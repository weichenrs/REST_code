# dataset settings
# _base_ = './fbp.py'
dataset_type = 'GLHWaterDataset_whole'
data_root = 'data/water/ori/'
data_test_root = data_root
crop_size = (12800, 12800)
...
train_dataloader = dict(
    ...
    sampler=dict(type='SPDefaultSampler', shuffle=True),
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        data_prefix=dict(
...
test_evaluator = dict(type='IoUMetric_sp_hw', iou_metrics=['mIoU, mFscore'])
