...
dataset_test_type = 'GLHWaterDataset_whole'
data_root = '../../data/lwc/cropped/water/512'
data_test_root = '../../data/lwc/water'
crop_size = (512, 512)
...
val_evaluator = dict(type='IoUMetric_binary', iou_metrics=['mIoU, mFscore'])
