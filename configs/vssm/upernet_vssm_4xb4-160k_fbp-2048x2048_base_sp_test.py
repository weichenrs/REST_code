...
# '../swin/fbp/swin-large-patch4-window7-skysense-pre_upernet_2xb2-80k_fbp-2048x2048_sp_layer_new_data.py'
'../swin/fbp/swin-large-patch4-window7-skysense-pre_upernet_2xb2-80k_fbp-2048x2048_sp_layer_new_data_slide2048.py'
]

# checkpoint_file = 'proj/spvit/work_dirs/fbp/vmamba/upernet_vssm_4xb4-160k_fbp-512x512_base.py/0806/best_mIoU_iter_46000.pth'
