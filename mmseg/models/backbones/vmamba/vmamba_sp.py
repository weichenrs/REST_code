...
from mmseg.models.backbones.sp_attn_layer import MYTransformerEncoderLayer
...
class MM_VSSM_sp(VSSM):
    def __init__(self, out_indices=(0, 1, 2, 3), pretrained=None, norm_layer="ln", **kwargs):
        ...
        for i in out_indices:
            ...
            spattn = MYTransformerEncoderLayer(
                    ...
                    feedforward_channels=4*self.dims[i],
                    attn_drop_rate=0,
                    drop_rate=0,
                    drop_path_rate=0,
                    num_fcs=2,
    ...
    def load_pretrained(self, ckpt=None, key="model"):
        ...
        try:
            ...
            if 'state_dict' in _ckpt:
                _state_dict = _ckpt['state_dict']
            elif 'model' in _ckpt:
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.layers):
            ...
            b, c, h, w = o.shape
            o = rearrange(o, 'b c h w -> b c (h w)', b=b, h=h, w=w, c=c)
            o = rearrange(o, 'b c (h w) -> b (h w) c', b=b, h=h, w=w, c=c)
            if i in self.out_indices:
                o = o + self.spattns[i](o)
            o = rearrange(o, 'b (h w) c -> b c (h w)', b=b, h=h, w=w, c=c)
            o = rearrange(o, 'b c (h w) -> b c h w'  , b=b, h=h, w=w, c=c)
