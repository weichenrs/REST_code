_base_ = [
    ...
    '../_base_/datasets/hpd_2048x2048_sp_1.py', '../_base_/default_runtime.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        type='MYVisionTransformer_ds_pos_hw', #cwwhu2 21s    #cwwhu 2048bs2 3.8s 2048bs8 16-21s 84096 30s
...
default_hooks = dict(
    ...
    visualization=dict(type='SegVisualizationHook', interval=1000)
    )
