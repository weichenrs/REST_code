_base_ = [
    ...
    '../_base_/datasets/fbp_4096x4096_sp.py', '../_base_/default_runtime.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        type='MYVisionTransformer_ds_pos_hw', #cwwhu2 21s    #cwwhu `2048`bs2 3.8s 2048bs8 16-21s 84096 30s
