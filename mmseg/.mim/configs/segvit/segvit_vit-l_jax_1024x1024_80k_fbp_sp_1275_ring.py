...
model = dict(
    ...
    backbone=dict(
        ...
        # type='MYVisionTransformer_ds_pos_hw', #cwwhu2 21s    #cwwhu 1024bs2 3.8s 1024bs8 16-21s 84096 30s
        type='SPVisionTransformer_hw', 
...
default_hooks = dict(
    ...
    visualization=dict(type='SegVisualizationHook', interval=270)
    )
