_base_ = [
    ...
    '../_base_/datasets/hpd_1024x1024.py', 
...
# train_cfg = dict(type='SPIterBasedTrainLoop', max_iters=40000, val_interval=8000)
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=False, interval=4000, 
                    max_keep_ckpts=8, save_best='mIoU'),
    visualization=dict(type='SegVisualizationHook', interval=500)
    )
